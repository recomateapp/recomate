...
import 'schema/user_ai_history_record.dart';
...
export 'schema/user_ai_history_record.dart';
...
/// Functions to query UserAiHistoryRecords (as a Stream and as a Future).
Future<int> queryUserAiHistoryRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<UserAiHistoryRecord>> queryUserAiHistoryRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      UserAiHistoryRecord.collection,
      UserAiHistoryRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UserAiHistoryRecord>> queryUserAiHistoryRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
