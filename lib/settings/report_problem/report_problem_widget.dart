...
class ReportProblemWidget extends StatefulWidget {
  ...
  static String routeName = 'report_problem';
  static String routePath = '/reportProblem';
...
class _ReportProblemWidgetState extends State<ReportProblemWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportProblemModel());
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (_model.formValidation!) {
                                      ...
                                      var reportRecordReference =
                                          ReportRecord.collection.doc();
                                      await reportRecordReference
                                      ...
                                      if (_model.reportFeedbackResp?.feedback !=
                                              null &&
                                          _model.reportFeedbackResp?.feedback !=
                                              '') {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          SnackBar(
                                            content: Text(
                                              'Report created. Will get back to via your email.',
                                              style: TextStyle(
                                                color:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
