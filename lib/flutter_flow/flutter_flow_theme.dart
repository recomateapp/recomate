...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF101010);
  late Color secondary = const Color(0x4D4B4B4B);
  late Color tertiary = const Color(0xFF191919);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF888888);
  late Color primaryBackground = const Color(0xFF101010);
  late Color secondaryBackground = const Color(0x4D3C3C4D);
