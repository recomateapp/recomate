...
import 'recommend_ai_movies_result_model.dart';
export 'recommend_ai_movies_result_model.dart';

/// Welcome screen
class RecommendAiMoviesResultWidget extends StatefulWidget {
  const RecommendAiMoviesResultWidget({
    super.key,
    this.aiRespData,
    String? test,
  }) : this.test = test ?? 'test';
  ...
  static String routeName = 'recommend_ai_movies_result';
  static String routePath = '/recommendAiMoviesResult';

  @override
  State<RecommendAiMoviesResultWidget> createState() =>
      _RecommendAiMoviesResultWidgetState();
}

class _RecommendAiMoviesResultWidgetState
    extends State<RecommendAiMoviesResultWidget> with RouteAware {
  late RecommendAiMoviesResultModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecommendAiMoviesResultModel());
  }
