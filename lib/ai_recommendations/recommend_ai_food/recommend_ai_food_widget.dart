...
import 'recommend_ai_food_model.dart';
export 'recommend_ai_food_model.dart';

/// Welcome screen
class RecommendAiFoodWidget extends StatefulWidget {
  const RecommendAiFoodWidget({
    super.key,
    String? location,
  ...
  static String routeName = 'recommend_ai_food';
  static String routePath = '/recommendAiFood';

  @override
  State<RecommendAiFoodWidget> createState() => _RecommendAiFoodWidgetState();
}

class _RecommendAiFoodWidgetState extends State<RecommendAiFoodWidget>
    with RouteAware {
  late RecommendAiFoodModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecommendAiFoodModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.addToUserResponses(<String, dynamic>{
        'question':
            FFAppState().fetchedFoodQuestions.firstOrNull?.questionTitle,
      });
      safeSetState(() {});
    });
  }
                                          ...
                                          interest:
                                              functions.convertListToString(
                                                  (currentUserDocument
                                                      ...
                                                      .toList()),
                                          prompt:
                                              '${functions.convertJsonToString(_model.userResponses.toList())} provide food or retaurant recommendation that are near my user location which is  ${widget!.location}',
