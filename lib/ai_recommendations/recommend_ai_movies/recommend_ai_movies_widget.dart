...
import 'recommend_ai_movies_model.dart';
export 'recommend_ai_movies_model.dart';

/// Welcome screen
class RecommendAiMoviesWidget extends StatefulWidget {
  const RecommendAiMoviesWidget({super.key});

  static String routeName = 'recommend_ai_movies';
  static String routePath = '/recommendAiMovies';

  @override
  State<RecommendAiMoviesWidget> createState() =>
      _RecommendAiMoviesWidgetState();
}

class _RecommendAiMoviesWidgetState extends State<RecommendAiMoviesWidget>
    with RouteAware {
  late RecommendAiMoviesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecommendAiMoviesModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.addToUserResponses(<String, dynamic>{
        'question':
            FFAppState().fetchedMovieQuestions.firstOrNull?.questionTitle,
      });
      safeSetState(() {});
    });
  }
